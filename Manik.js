...
global.called = false
global.Prefix = 'Multi'
global.ownerNumber = '6289653633058'
global.botName = '𝐙𝐞𝐮𝐳' 
global.owner = ['6289653633058']
global.ownerName = '𝐙𝐞𝐮𝐳'
global.packName = '𝐙𝐞𝐮𝐳' 
global.author = '𝐳𝐞𝐮𝐳'
...
const reply1 = (teks) => {
Manik.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botName}`,"body": `Follow Instagram backwanz`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/Manik.jpg`),"sourceUrl": "https://instagram.com/backwanz"}}}, { quoted: m})
}
...
const buttonsDefault = [
			{ callButton: { displayText: `Call Owner!`, phoneNumber: `+628965363058` } },
			{ urlButton: { displayText: `Instagram Owner`, url : `https://instagram.com/𝐛𝐚𝐜𝐤𝐰𝐚𝐧𝐳` } },
...
const buttonsFirst = [
			{ callButton: { displayText: `Call Owner!`, phoneNumber: `+6289653633058` } },
			{ urlButton: { displayText: `Instagram Owner`, url : `https://instagram.com/backwanz` } },
 ...
 *｢  BOT MENU  ｣*  	
 ...
 © DESIGN: 𝙕𝙚𝙪𝙯`
 Manik.sendMessage(m.chat, { caption: anu, image: { url: "./media/menu.jpg" }, templateButtons: buttonsDefault, footer: '© Zeuz', mentions: [m.sender] })
break 
}
...
addCountCmd(`#${command.slice(1)}`, sender, _cmd) 
  ...
  Tanggal Server : ${moment.tz('Asia/Jakarta').format('DD/MM/YY')}
  Waktu Server : ${moment.tz('Asia/Jakarta').format('HH:mm:ss')}
  Join Us: zeuzstore.blogspot.com
 ...
 © DESIGN: SANZY YT`
 Manik.sendMessage(m.chat, { caption: anu, image: { url: "./media/menu.jpg" }, templateButtons: buttonsFirst, footer: '© 𝙕𝙚𝙪𝙯', mentions: [m.sender] })
break 
}
case prefix+'jaksel':
...
let noshp = text
if (isNaN(parseInt(noshp))) return reply(`${command} 6289653633058`)
const sections = [
    {
...
_Contoh:_
${prefix}bukti 10000|isi Saldo 6289653633058
...
let encmedia = await Manik.sendImage(`62881027694993@s.whatsapp.net`, media, `Bukti Dari: ${sender.replace("@s.whatsapp.net", "")}`, m)
let buttons = [
...
Manik.sendButtonText(`62881027694993@s.whatsapp.net`, buttons, `${bukti}`, Manik.user.name, m)
}
break
case prefix+'depoyes':
if (!isManik) reply(mess.owner)
...
Please @${m.mentionedJid[0].split`@`[0]} to type accept/reject`
	    ...
	    case prefix+'donasi': case prefix+'donate': case prefix+'sewabot': case prefix+'sewa': case prefix+'buypremium': case prefix+'jadibot':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                reply(` LIST!\n\nHi ${pushname} \n\`\`\`GOPAY : CHAT OWNER\`\`\`\n\`\`\`DANA : CHAT OWNER\`\`\`\n\`\`\`PULSA : TANYA OWNER\`\`\`\nUntuk list harga silahkan chat🎳: wa.me//6289653633058 _^\n THX FOR YOU ! `)
            }
            break
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://chat.whatsapp.com/I8BX3GHxkBRBnYolzZhnQt'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Owner',
...
Manik.sendMessage(m.chat, { contacts: { displayName: 'Arya Manik√', contacts: [{ vcard }] } }, { quoted: m })
    ...
    + 'item4.X-ABLabel:Region\n'
    + 'END:VCARD'
Manik.sendMessage(m.chat, { contacts: { displayName: 'Sanzy', contacts: [{ vcard }] } }, { quoted: m })
                        ...
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                urlButton: {
                                    ...
                                    url: 'https://instagram.com/sanzykawai_24'
                                }
                            }, {
                            	urlButton: {
                                displayText: 'Group',
...
const sendMsg = await Manik.sendMessage(m.chat, listMessage)
        ...
        case 'proses':
            ...
            m.quoted.copyNForward(`6289653633058@s.whatsapp.net`, true)
            Manik.sendMessage(`6289653633058@s.whatsapp.net`, {text: proses })
            break
        case 'done':
            if (!isManik) return
